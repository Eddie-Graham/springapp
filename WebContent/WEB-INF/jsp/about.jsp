...
<t:genericpage>
    ...
    <jsp:body>
        ...
        <div class="header">
            <h1>Fishing for Likes</h1>
            <h2>Me wants attention</h2>
        </div>

        <div class="content">
            <h2 class="content-subhead">How does this site work?</h2>
            <p>
                Fishing for Likes works the exact way modern society does: the most popular win.
            </p>
