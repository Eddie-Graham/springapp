    ...
    <div class="postContainer" style="background-color: ${backgroundColor};">
        ...
        <div class="post">
            ...
            <div class="profileDiv">
                <div class="image">
                    <c:choose>
                        <c:when test="${post.user.hasProfilePic}">
                            <a href="myprofile.html?id=${post.user.id}"><img class="profilePic"
                                                                             src="profile_images/${post.user.id}.png"
                                                                             alt="Profile pic"></a>
                        </c:when>
                        <c:otherwise>
                            <a href="myprofile.html?id=${post.user.id}"><img class="profilePic"
                ...
                <div class="username">
                    <a href="myprofile.html?id=${post.user.id}" class="links"><strong><c:out
                            value="${post.user.username}"/></strong></a>
                </div>
                        ...
                        <c:forEach items="${splitText}" var="token">
                            ...
                            <c:choose>
                                <c:when test="${fn:startsWith(token, '#')}">
                                    <strong><a href="javascript:refreshPostsByTag('${token}', '${userId}');"
                                               style="color: red;" class="links"><c:out value="${token}"/></a></strong>
                                </c:when>
                                <c:otherwise>
                                    <c:out value="${token}"/>
                                </c:otherwise>
